        ...
        <div component="$UI/system/components/justep/list/list" class="x-list"
          ...
          <table class="table table-bordered table-hover table-striped" component="$UI/system/components/bootstrap/table/table"
            ...
            <tbody class="x-list-template" xid="listTemplate2"> 
              ...
              <td xid="td1" style="text-align:center;"><a component="$UI/system/components/justep/button/button" class="btn btn-default btn-xs hidden-element" label="编辑" xid="editBtn" onClick="editBtnClick">
   <i xid="i3"></i>
   <span xid="span4">编辑</span></a><a component="$UI/system/components/justep/button/button" class="btn btn-default btn-xs hidden-element" label="删除" xid="delBtn" onClick="delBtnClick">
   <i xid="i2"></i>
...
<span component="$UI/system/components/justep/windowDialog/windowDialog" xid="windowDialog3" style="top:255px;left:113px;" status="normal" width="25%" height="50%" src="./detailoil.w">
